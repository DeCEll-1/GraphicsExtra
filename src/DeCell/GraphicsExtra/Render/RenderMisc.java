...
//            result.add(NormaliseVector(vector));
    ...
    public static List<Vector3f> Vector2f2_0_1_Vector2f(List<Vector3f> worldVectorList) {
        // turns vector to 0-1
    ...
    public static List<Vector4f> Colors2Vectors(List<Color> colors) {
        ...
        for (Color color : colors) {
            result.add(new Vector4f(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()));
        }
        return result;
    }
